...
def main():
    argparser = ap.ArgumentParser('PHOENIX wrapper for GENEActiv MTL2 Pipeline')
    ...
    argparser.add_argument('--mtl-dir',
        help='FREQ directory',
        default='/ncf/nrg/sw/lib/freq/master/')
    ...
    argparser.add_argument('--ext-mode',
        help='Data extraction mode (all, new). (Default: all)',
        default = 'all')
    ...
    for study in studies:
        ...
        for subject in subjects:
            ...
            data_path = args.input_dir if args.input_dir else os.path.join(subject_path, 
                args.data_type, 'processed')
