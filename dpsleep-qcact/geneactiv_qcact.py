...
def main():
    argparser = ap.ArgumentParser('PHOENIX wrapper for GENEActiv QCACT Pipeline')
    ...
    argparser.add_argument('--mtl-dir',
        help='QCACT directory',
        default='/ncf/nrg/sw/lib/qcact/master/')
        ...
        for subject in subjects:
            ...
            if args.data_type == 'phone':
                ...
                new_args, unknown = mod_parser.parse_known_args([
                    ...
                    '--phoenix-dir',str(args.phoenix_dir),
